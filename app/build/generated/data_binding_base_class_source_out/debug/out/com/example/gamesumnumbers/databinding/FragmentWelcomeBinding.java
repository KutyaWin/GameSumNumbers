...
public final class FragmentWelcomeBinding implements ViewBinding {
  ...
  private FragmentWelcomeBinding(@NonNull ScrollView rootView, @NonNull Button buttonUnderstand,
      @NonNull ImageView ivLogo, @NonNull TextView tvTitle) {
    this.rootView = rootView;
    this.buttonUnderstand = buttonUnderstand;
    this.ivLogo = ivLogo;
  ...
  public static FragmentWelcomeBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.button_understand;
      Button buttonUnderstand = ViewBindings.findChildViewById(rootView, id);
      if (buttonUnderstand == null) {
        break missingId;
      }
      ...
      return new FragmentWelcomeBinding((ScrollView) rootView, buttonUnderstand, ivLogo, tvTitle);
    }
